...
chart_details <- list(
	id = "police-numbers",
	title = "Police cuts haven't hit everywhere equally",
	subtitle = "There are almost 22,000 fewer police officers in England and Wales than in 2010, but numbers haven't dropped equally across police forces. One force (Surrey) has more officers now than 10 years ago, while officer numbers in forces like Humberside are increasing after steep cuts. But in almost half of forces, numbers are still falling despite a decade of often above-average cuts already.",
...
if (!file.exists(paste0(chart_details$id, "-data.csv.gz"))) {
	...
	GET("https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/726009/open-data-table-police-workforce.ods", write_disk(new_data_file))
...
chart <- chart_data %>% 
	...
	scale_x_continuous(breaks = c(2010, 2018), labels = c("'10", "'18")) + 
	scale_y_continuous(
	...
	scale_colour_manual(
		...
		values = unname(ucl_colours_list[c("Bright Green", "Bright Pink", 
...
[larger image](../`r chart_details$id`.png) | [annotated R code to produce this chart](https://github.com/mpjashby/cj-charts/blob/master/content/`r chart_details$id`.Rmd)
