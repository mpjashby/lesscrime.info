...
chart_data <- tidy_data %>% 
	...
	mutate(
		...
		league = fct_rev(paste(league, "(2018–19)"))
	) %>% 
...
chart_labels <- tribble(
	...
	"Crystal Palace", 16, "Brighton & Hove", 20, "Premier League (2018–19)", balance_lines("a higher proportion of arrests of fans of some clubs (e.g. Newcastle and Crystal Palace) occurred on the road, compared to most clubs", 3), "left", "center", "right",
	"Leeds", 54, "Middlesbrough", 52.5, "Championship (2018–19)", balance_lines("Birmingham City fans were arrested more often away from home than most clubs' home and away arrests combined", 3), "right", "top", "left",
	"Queens Park Rangers", 21.5, "Queens Park Rangers", 25, "Championship (2018–19)", balance_lines("half of clubs in this league had more/fewer arrests than this value", 3), "left", "center", "left"
) %>% 
