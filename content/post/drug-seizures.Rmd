...
chart_labels <- tribble(
	...
	ymd("2012-10-01"), 74, ymd("2015-10-01"), 64, "ketamine (9th)", balance_lines("rank of relative harm caused by different drugs, according to Nutt et al. 2010", 3), "left", "top", "right",
