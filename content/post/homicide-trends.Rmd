...
chart_details <- list(
	...
	subtitle = "The rapid decrease in the homicide (murder, manslaughter and infantice) rate in England and Wales between 2000 and 2014 was unprecedented over the previous century, but a third of that decrease has already been reversed.",
...
chart <- ggplot(chart_data, aes(year, homicide_rate)) +
  ...
  geom_smooth(aes(colour = "line"), method = "loess", span = 0.2, se = FALSE, 
