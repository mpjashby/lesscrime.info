...
chart_details <- list(
	...
	subtitle = "Among the 42 million adults in England and Wales aged between 16 and 74, 1.3 million have been sexually assaulted by a partner, 4.3 million subjected to non-sexual assault and 2.3 million have been stalked. In every category, at least twice as many women as men have been victimised by a partner.",
...
chart_labels <- tribble(
	...
	5.4, 4.9e6, "threats", 4.75e6, "women", balance_lines("almost 5 million women have been victims of domestic abuse", 3), "right", "top", "left"
)
```
